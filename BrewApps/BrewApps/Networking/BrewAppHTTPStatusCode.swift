...
enum BrewAppHTTPStatusCode: Int, Error {
...
extension HTTPURLResponse {
    ...
    var status: BrewAppHTTPStatusCode? {
        return BrewAppHTTPStatusCode(rawValue: statusCode)
    }
    
}

extension BrewAppHTTPStatusCode: Codable{
